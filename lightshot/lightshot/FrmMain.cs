...
namespace lightshot
{
    public partial class FrmMain : Form
    {
        ...
        {
            string ocr_path = @"C:\Program Files\Tesseract-OCR\tesseract.exe";
            if (File.Exists("ocr.exe") &&
                        File.Exists(ocr_path))
            {
                ...
                MessageBox.Show("Bazı ana bileşenler eksik lütfen lightshot programını kaldırıp tekrar kurunuz.\n" +
                    $"Bir diğer hata nedeni: \"{ocr_path}\" not found", "lightshot", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
